...
import { PageShell, SettingsPage, SettingsSection, type SubNavGroup } from "../../components/layout";
...
// 分页的标识。顺序即二级目录里的渲染顺序。
type SecKey = "general" | "conn" | "device" | "keys" | "trash" | "about";
...
export function Settings() {
  ...
  return (
    <PageShell header={{ title: t("settings.title") }}>
      <SettingsPage nav={nav} active={sec} onSelect={(k) => setSec(k as SecKey)}>
