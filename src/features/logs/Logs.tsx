  ...
  return (
    <div className="h-full flex flex-col min-h-0">
      <div className="flex items-center justify-between px-[22px] py-[14px] border-b border-border shrink-0 gap-3">
        ...
        <button className="flex items-center gap-1.5 px-3 py-1.5 border border-border bg-card text-text rounded-lg text-[12.5px] cursor-pointer">{t("logs.openFolder")}</button>
      </div>
